...
if __name__ == "__main__":
    # default filename = "../logs/sample_BIKprotect_log.txt"
    if len(sys.argv) == 1:
        file_name = "logs/sample_BIKprotect_log.txt"
    else:
